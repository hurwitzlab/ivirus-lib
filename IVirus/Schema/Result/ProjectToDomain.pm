use utf8;
package IVirus::Schema::Result::ProjectToDomain;
...
Related object: L<IVirus::Schema::Result::Domain>

=cut

__PACKAGE__->belongs_to(
  "domain",
  "IVirus::Schema::Result::Domain",
  { domain_id => "domain_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qxmWC8gSm2df4DVXeZVJZg
